...
const modes: Omit<Record<GameMode, LocalizedTuple>, 'swordDuel'> = {
  ...
  craftSurvival: { en: ['Survival', 'Build a barricade base during peace time. Weapons unlock later.'], ru: ['Выживание', 'В мирное время строй базу из баррикад без перезарядки. Потом включается оружие.'] },
