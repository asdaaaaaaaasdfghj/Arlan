  ...
  return (
    <header className="game-hud">
      <div>
        ...
        {game.mutation.id !== 'none' && <p className="mode-description mutation-line">{getMutationName(game.mutation, language)}: {getMutationDescription(game.mutation, language)} {getMutationCountText(game.activeMutations ?? [], language)}</p>}
