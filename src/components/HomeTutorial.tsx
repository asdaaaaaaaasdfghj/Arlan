...
const enCards: TutorialCard[] = [
  ...
  { group: 'Modes', title: 'Mode Types', tag: 'Playlist', text: 'Modes are sorted into classic, zombie, strategy, arcade and other. Mini Games rotates rules every 30 seconds.' },
  ...
  { group: 'Progress', title: 'Settings', tag: 'Options', text: 'Change language, FPS, low-spec mode, controls, bot difficulty, bot weapons, music, dark mode, secret zombies and achievement popups.' },
];
...
const ruCards: TutorialCard[] = [
  ...
  { group: 'Режимы', title: 'Типы режимов', tag: 'Список', text: 'Режимы отсортированы на классические, зомби, стратегии, аркады и другое. Mini Games меняет правила каждые 30 секунд.' },
  ...
  { group: 'Прогресс', title: 'Настройки', tag: 'Опции', text: 'Можно менять язык, FPS, режим для слабых ПК, управление, сложность ботов, оружие ботов, музыку, тёмный режим, секретных зомби и ачивки.' },
];
